...
設計、明示的な割り当て、ターン計画、遠征判断、代理リーダー選択、シミュレーション状態機械まで完了しています。Unityの手動経営UIでは各メンバーの選択、CPU委任、計画確定に加え、遠征勝利後の戦闘結果・報酬・参加者HPを確認して続行、帰還、CPU委任を選べます。次はPhase 2の完成確認を行います。
